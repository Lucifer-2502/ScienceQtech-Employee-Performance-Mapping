...
BEGIN SELECT EMP_ID,FIRST_NAME,LAST_NAME,EXP 
FROM emp_record_table 
WHERE EXP>3; 
END && 
...
RETURNS VARCHAR(40) 
DETERMINISTIC BEGIN DECLARE Employee_ROLE VARCHAR(40); 
